...
public class AddNewPostActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    public static String POST(String url, Post post){
        ...
        try {
            ...
            // hardcoded
            nvps.add(new BasicNameValuePair("company", "kennethsoh"));
            ...
            // hardcoded
            nvps.add(new BasicNameValuePair("email", "kssc91@hotmail.com"));
            ...
            // hardcoded
            httpPost.setHeader("Authentication-Token", "9oxnaSAJUMF8fcsygmnG");
